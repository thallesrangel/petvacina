...
{   
     ...
     public function getEspecifico($id) {
        $array = array();
        $sql = "SELECT * FROM tbparasita WHERE id_animal = ".$id." AND id_usuario = ".$_SESSION['id_usuario']." AND flag_excluido = 0";
    ...
    {     
        ...
        $sql = "INSERT INTO tbparasita (id_usuario, id_animal, nome_produto, dose, data_aplicacao, data_prox_dose, nome_veterinario, registro_crmv, data_registro) 
