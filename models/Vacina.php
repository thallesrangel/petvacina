...
class Vacina extends model 
{
    ...
    public function getEspecifico($id) {
        $array = array();
        $sql = "SELECT * FROM tbvacina WHERE id_animal = ".$id." AND id_usuario = ".$_SESSION['id_usuario']." AND flag_excluido = 0";
    ...
    public function add($id_animal, $nome_vacina, $dose, $valor_total, $data_aplicacao, $data_revacinacao, $nome_veterinario, $registro_crmv)
    {     

        $sql = "INSERT INTO tbvacina (id_usuario, id_animal, titulo_vacina, dose, valor_total, data_aplicacao, data_revacinacao, nome_veterinario, registro_crmv, data_registro) 
        VALUES(:id_usuario, :id_animal, :titulo_vacina, :dose, :valor_total, :data_aplicacao, :data_revacinacao, :nome_veterinario, :registro_crmv,:data_registro)";
