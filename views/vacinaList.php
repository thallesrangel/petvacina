...
<div class="container bg-white p-1">
    ...
    <ul class="pagination">
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vacina/?p=1">Primeira</a></li>
            <?php
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vacina/?p=<?= $paginas;?>"> Última </a></li>
    </ul>
</div>