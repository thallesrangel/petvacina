<div class="container bg-white rounded h-75">
    ...
    <a class="list-color-text" href="<?=BASE_URL?>vacina/detalhes/<?=$item['id_animal']?>">
        <div class="card col-md-2 col-sm-3 align-items-center float-left mt-3 card-animal">
...
<div class="container bg-white p-1">
    ...
    <ul class="pagination">
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vacina/?p=1"> <i class="icon-menu" data-feather="chevron-left"></i> </a></li>
            <?php
                for ($pag_ant = $paginaAtual - $max_links; $pag_ant <= $paginaAtual - 1; $pag_ant++){
                    if($pag_ant >= 1){
                        ?>
                    
                        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vacina/?p=<?= $pag_ant;?>"><?= $pag_ant;?> </a></li>
                        <?php
                    }
                }
            ...
            for ($pag_dep = $paginaAtual + 1; $pag_dep <= $paginaAtual + $max_links; $pag_dep++){
                ...
                if($pag_dep <= $paginas){ ?>
                    <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vacina/?p=<?= $pag_dep;?>"> <?= $pag_dep;?></a></li>
                <?php
                }
            }
        ?>

        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vacina/?p=<?= $paginas;?>"> <i class="icon-menu" data-feather="chevron-right"></i>  </a></li>
    </ul>
</div>