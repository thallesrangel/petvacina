...
<div class="container bg-white p-1">
    ...
    <ul class="pagination">
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>animal/?p=1"> <i class="icon-menu" data-feather="chevron-left"></i> </a></li>
            <?php
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>animal/?p=<?= $paginas;?>"> <i class="icon-menu" data-feather="chevron-right"></i> </a></li>
    </ul>
</div>
