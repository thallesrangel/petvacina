<div class="container bg-white rounded h-75">
    ...
    ?>  
    <a class="list-color-text" href="<?=BASE_URL?>metrica/detalhes/<?=$item['id_animal']?>">
...
<div class="container bg-white p-1">
    ...
    <ul class="pagination">
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>metrica/?p=1"> <i class="icon-menu" data-feather="chevron-left"></i> </a></li>
            <?php
                for ($pag_ant = $paginaAtual - $max_links; $pag_ant <= $paginaAtual - 1; $pag_ant++){
                    if($pag_ant >= 1){
                        ?>
                    
                        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>metrica/?p=<?= $pag_ant;?>"><?= $pag_ant;?> </a></li>
                        <?php
                    }
                }
            ...
            for ($pag_dep = $paginaAtual + 1; $pag_dep <= $paginaAtual + $max_links; $pag_dep++){
                ...
                if($pag_dep <= $paginas){ ?>
                    <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>metrica/?p=<?= $pag_dep;?>"> <?= $pag_dep;?></a></li>
                <?php
                }
            }
        ?>

        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>metrica/?p=<?= $paginas;?>"> <i class="icon-menu" data-feather="chevron-right"></i> </a></li>
    </ul>
</div>