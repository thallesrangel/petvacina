...
<div class="container text-center bg-white">
    ...
    <div class="row justify-content-md-center mb-2">
        ...
        <div class="col-sm-12 col-md-3 text-sm-center text-md-left">
            ...
            <a class="btn btn-sm btn-primary mb-3" href="<?=BASE_URL?>anticio/registrar/<?=$dados_animal['id_animal'];?>"><i class="icon-white" data-feather="plus"></i> Registrar</a>
        ...
        <div class="col-md-10 border rounded bg-white p-2">
            ...
            <?php foreach($lista as $item) { ?>
                <tr>
                    ...
                    <td>
                        <a href="<?=BASE_URL?>anticio/editar/<?=$item['id_anticio']?>"><i class="icon" data-feather="edit"></i><a> 
                        <a href="<?=BASE_URL?>anticio/deletar/<?=$item['id_anticio']?>"><i class="icon-red" data-feather="trash"></i></a>
                    </td>
                </tr>
            <?php
                }
