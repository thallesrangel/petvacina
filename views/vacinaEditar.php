...
<div class="container bg-white rounded h-75">
    <div class="d-sm-flex align-items-center justify-content-between mb-1 pt-2">
        <h4 class="ml-2 gray-color">Editar Vacina</h4>
    </div>
    ...
    <form method="POST" class="p-2" action="<?=BASE_URL?>animal/editar/<?=$url[2];?>">
        <div class="row">
            ...
            <div class="col-md-3">
                <label for="titulo_vacina">Produto *</labe>
                <input id="titulo_vacina" type="text" class="form-control form-control-sm" value="<?= $dados['titulo_vacina']?>" name="titulo_vacina">
            </div>
