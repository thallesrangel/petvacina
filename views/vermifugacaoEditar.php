...
<div class="container bg-white rounded h-75">
    <div class="d-sm-flex align-items-center justify-content-between mb-1 pt-2">
        <h4 class="ml-2 gray-color">Editar Vermifugação</h4>
    </div>
    ...
    <form method="POST" class="p-2" action="<?=BASE_URL?>vermifugacao/editar/<?=$url[2];?>">
        <div class="row">
            <input type="hidden" class="form-control form-control-sm" value="<?= $url[2] ?>" name="id_vermifugacao">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input id="peso" type="text" class="form-control form-control-sm" value="<?= $dados['peso'] ?>" name="peso_animal">
            </div>
