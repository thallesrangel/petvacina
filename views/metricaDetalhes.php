...
<div class="container text-center bg-white">
    ...
    <div class="row justify-content-md-center mb-2">
        ...
        <div class="col-sm-12 col-md-3 text-sm-center text-md-left">
            ...
            <a class="btn btn-sm btn-primary mb-3" href="<?=BASE_URL?>metrica/registrar/<?=$dados_animal['id_animal'];?>"><span><img src="<?= BASE_URL?>assets/img/icon/plus.svg"> Registrar </span></a>
            <a class="btn btn-sm btn-primary mb-3" href="#"><span><img src="<?= BASE_URL?>assets/img/icon/printer.svg"> Imprimir </span></a>
        </div>
    
    </div>
    
    <h4>Cartão Métrica do Animal</h4>
        ...
        <div class="col-md-10 border rounded bg-white p-2">
            ...
            <?php foreach($lista as $item) { ?>
                <tr>
                    ...
                    <td><?=$item['data_medida'] == null ? 'Sem repesagem' : date("d/m/Y", strtotime($item['data_medida']))?></td>
                    <td>
                        <a href="<?=BASE_URL?>metrica/editar/<?=$item['id_metrica_animal']?>"><i class="icon" data-feather="edit"></i><a> 
                        <a href="<?=BASE_URL?>metrica/deletar/<?=$item['id_metrica_animal']?>"><i class="icon-red" data-feather="trash"></i></a>
                    </td>
                </tr>
            <?php
                }
