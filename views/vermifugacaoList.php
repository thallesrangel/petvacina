...
<div class="container">
    ...
    <ul class="pagination">
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vermifugacao/?p=1">Primeira</a></li>
            <?php
        ...
        <li class="page-item"><a class="page-link" href="<?= BASE_URL;?>vermifugacao/?p=<?= $paginas;?>"> Última </a></li>
    </ul>
</div>