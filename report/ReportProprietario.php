...
{  
    ...
    { 
        ...
        $this->Cell(15,8,'Contato',1,0,'L');
        $this->Cell(25,8,'E-mail',1,0,'L');
        $this->Cell(20,8,'Estado',1,0,'L');
        $this->Cell(20,8,'Cidade',1,0,'L');
    ...
    function viewTable()
    {
        ...
        foreach($dados as $value) {
            ...
            $this->Cell(10,7, $value['id_proprietario'],1,0,'L');
            $this->Cell(20,7,$value['nome_proprietario'] . " " . $value['sobrenome_proprietario'] ,1,0,'L');
            $this->Cell(20,7, date("d/m/Y", strtotime($value['data_nascimento'])),1,0,'L');
            $this->Cell(15,7, $value['contato'],1,0,'L');
            $this->Cell(25,7, $value['email'],1,0,'L');
            $this->Cell(20,7, utf8_decode($value['nome_estado']),1,0,'L');
            $this->Cell(20,7, utf8_decode($value['nome_cidade']),1,0,'L');
            $this->Ln();
        }
